...
@RestController
@CrossOrigin(origins = "*") // Tambahkan ini agar frontend bisa akses API tanpa blokir
public class UserController {
    ...
    public ResponseEntity<Map<String, Object>> DeleteUser(@PathVariable("id") String id) {
        ...
        return ResponseEntity.status(HttpStatus.OK).body(Map.of("status", "success delete user with id " + id));
    }
}